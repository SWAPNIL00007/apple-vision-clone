// locomotive is used to call function loco
function loco(){
...
// this code is used to play the vedio below nav bar
// timeline is a feature of gsap
gsap.to("#page>vedio",{
    ScrollTrigger:{
        trigger:'#page>video',
        start:'2% top',
...
// timline for page 1 so that it can scroll from up and down
// timline is used move text up and down
